...
def main():
    ...
    subfolder = "dcase18"
    revision = "data"
    local_dir = f"{root}/data/"  # Replace with the local directory where the file will be downloaded
    repo_type = "dataset"
    # Download the file
    ...
    os.chdir(f"{root}/data/dcase18")

    # The directory where you want to extract the files
    output_directory = f"{root}/data/background_noise/"
