...
#SBATCH --job-name=bigshot_linear_base_frozen
#SBATCH --output=/mnt/work/bird2vec/logs/bigshot/full_bigshot_linear_base_frozen_%N_%a.log
...
CONFIG_PATH="experiment=paper/bigshot/birdMAE/frozenlin_base/${DATASETS[$DATASET_IDX]}_base.yaml"

echo "Running experiment: ${CONFIG_PATH} with seed: ${SEED}"
DATASET_NAME=${DATASETS[$DATASET_IDX]}
scontrol update job=$SLURM_JOB_ID name="bigshot_base_frozen_linear_full_${DATASET_NAME}_seed${SEED}_${SLURM_ARRAY_TASK_ID}"
